					...
					<?php
                        ...
                        if(isset($_POST['book'])){
                        	...
                        	if(empty($sym)){
                        		...
                        		$query="INSERT INTO appointment(firstname, surname, gender, phoneno, appointment_date, symptoms, status, date_booked)VALUES('$firstname','$surname','$gender','$phoneno','$date','$sym','Pending',NOW())";
