...
if(isset($_POST['create'])){
	...
	if(count($error) == 0){
		...
		$query="INSERT INTO patient( firstname, surname, username,email,gender,phoneno, country, password, data_reg, profile) VALUES('$firstname','$surname','$username','$email','$gender','$phoneno','$country','$password',NOW(),'patient.jpg')";
