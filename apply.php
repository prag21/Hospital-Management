...
if(isset($_POST['apply'])){
	...
	if(count($error) == 0){
		...
		$query="INSERT INTO doctors( firstname, surname, username,email,gender,phoneno, country, password, salary, data_reg,status, profile) VALUES('$firstname','$surname','$username','$email','$gender','$phoneno','$country','$password','0',NOW(),'Pending','doctor.jpg')";
